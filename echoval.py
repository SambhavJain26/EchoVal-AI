...
class App:
    ...
    def run(self):
        with gr.Blocks(title="Echoval AI", fill_width=True, css="""
            #logs_column {
                max-width: 400px;
            }
            """) as ui:
            ...
            with gr.Row():
                gr.Markdown('<div style="text-align: center;font-size:24px"><strong>Echoval AI</strong> - Autonomous Agent Framework that hunts for deals</div>')
            with gr.Row():
            ...
            with gr.Row():
                ...
                with gr.Column(scale=1, elem_id="logs_column"):
                    logs = gr.HTML()
